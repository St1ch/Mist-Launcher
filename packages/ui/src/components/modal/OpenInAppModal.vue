...
const messages = defineMessages({
	openingApp: {
		...
		defaultMessage: 'Opening Mist Launcher',
	},
	whyUseApp: {
		id: 'modal.open-in-app.why-use',
		defaultMessage: 'Why use the Mist Launcher',
	},
	benefitLaunch: {
	...
	openingAutomatically: {
		...
		defaultMessage: 'The Mist Launcher will open automatically...',
	},
	getApp: {
		id: 'modal.open-in-app.get-app',
		defaultMessage: 'Get Mist Launcher',
	},
})
