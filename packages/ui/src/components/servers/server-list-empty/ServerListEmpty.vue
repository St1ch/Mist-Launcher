...
const messages = defineMessages({
	...
	noServersDescription: {
		...
		defaultMessage: 'Install mods, invite friends, and play together all from the Mist Launcher.',
	},
	...
	playWithFriendsDescription: {
		...
		defaultMessage: 'Invite friends and get them set up right in the Mist Launcher.',
	},
	newServerButton: {
