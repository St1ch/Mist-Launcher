...
fn main() {
    ...
    */
    ...
    tracing::info!("Initialized tracing subscriber. Loading Mist Launcher!");
            ...
            #[cfg(target_os = "windows")]
            {
                ...
                if format!("{e:?}").contains(
                    ...
                    DialogBuilder::message()
                        .set_level(MessageLevel::Error)
                        .set_title("Initialization error")
                        .set_text("Your Microsoft Edge WebView2 installation is corrupt.\n\nMicrosoft Edge WebView2 is required to run Mist Launcher.\n\nLearn how to repair Microsoft Edge WebView2 from Microsoft's official support resources.")
                        .alert()
                        .show()
                        .unwrap();
