...
<template>
	<div class="flex items-center justify-between gap-4">
		<div>
			...
			<p class="m-0 mt-1 text-sm">
				The ad provider shows ads based on your preferences. By disabling this
	...
	<div class="mt-4 flex items-center justify-between gap-4">
		<div>
			...
			<p class="m-0 mt-1 text-sm">
				Mist Launcher collects anonymized analytics and usage data to improve our user experience and
	...
	<div class="mt-4 flex items-center justify-between gap-4">
		<div>
			...
			<p class="m-0 mt-1 text-sm">
				Manages the Discord Rich Presence integration. Disabling this will cause Mist Launcher to no
